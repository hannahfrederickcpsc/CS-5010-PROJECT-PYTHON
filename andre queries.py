...
print('We see a very low p-value, indicating that there is indeed a significant difference in mean turnout in presidential election years versus non-presidential election years.')
