...
soup = BeautifulSoup(open('senate_election.html'), 'html.parser')
...
filename = 'senate_results.csv'
with open(filename, 'w', newline='') as f: 
    w = csv.DictWriter(f,['Year', 'Office', 'Winner', 'Party', "Winner's Vote Count", "Winner's Percent of Total Votes"]) 
    w.writeheader() 
